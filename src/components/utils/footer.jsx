      ...
      <div className="container pb-4 sm:px-20 h-auto">
        <footer className="px-4 flex justify-center space-x-8">
          ...
          <a href="https://leetcode.com/rohanny_/">
            <img src={lc} alt="github" className="w-5 cursor-pointer" />
          </a>
          <a href="https://www.linkedin.com/in/rohan-yadav-91407a1a0/">
            <img src={inn} alt="github" className="w-6 cursor-pointer" />
          </a>
          <a href="/">
            <img src={insta} alt="github" className="w-6 cursor-pointer" />
          </a>
