      ...
      <div className="container mx-auto px-4 sm:px-20 py-10 my-10 h-auto border-l border-r border-borderColor">
        ...
        <div className="mx-auto py-5  w-full sm:grid sm:grid-cols-8">
          ...
          <div className="col-span-6 px-4 sm:px-10 sm:py-10 space-y-5">
            <Reveal>
              <h2 className="font-satoshi font-medium text-2xl">Fine Dine</h2>
            </Reveal>
            <Reveal>
            ...
            <div className="flex space-x-6">
              <div className="flex space-x-6">
                <a href="https://github.com/geek-lords/fine-dine-admin-frontend">
                  <img src={git} alt="github" className="w-8 cursor-pointer" />
                </a>
                <a href="https://abhiraj-kale.github.io/fine-dine-admin-frontend/public/webpages/homepage.html">
        ...
        <div className="mx-auto py-5 w-full sm:grid sm:grid-cols-8">
          ...
          <div className="col-span-6 px-4 sm:px-10 sm:py-10 space-y-5">
            ...
            <div className="flex space-x-6">
              <a href="https://github.com/rohannY/summarizer-ui">
                <img src={git} alt="github" className="w-8 cursor-pointer" />
              </a>
            </div>
          </div>
        ...
        <div className="mx-auto py-5 w-full sm:grid sm:grid-cols-8">
          ...
          <div className="col-span-6 px-4 sm:px-10 sm:py-10 space-y-5">
            ...
            <div className="flex space-x-6">
                <a href="https://github.com/rohannY/PreetiBhojan">
                  <img src={git} alt="github" className="w-8 cursor-pointer" />
                </a>
                <a href="https://preetibhojan.co.in/">
                  <img src={live} alt="live" className="w-8 cursor-pointer" />
                </a>
              </div>
          </div>
        ...
        <div className="mx-auto py-5 w-full sm:grid sm:grid-cols-8">
          ...
          <div className="col-span-6 px-4 sm:px-10 sm:py-10 space-y-5">
            <Reveal>
              <h2 className="font-satoshi font-medium text-2xl">Cine Phile</h2>
            </Reveal>
            <Reveal>
              <p className="font-figtree text-sm sm:text-lg font-thin text-lightGrey ">
            ...
            <div className="flex space-x-6">
                <a href="https://github.com/rohannY/Cine-Phile">
                  <img src={git} alt="github" className="w-8 cursor-pointer" />
                </a>
              </div>
          </div>
