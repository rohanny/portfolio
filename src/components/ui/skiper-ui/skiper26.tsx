...
const Skiper26 = () => {
  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center">
      ...
      <div className="text-oklch(0.141 0.005 285.823) grid content-start justify-items-center gap-6 py-20 text-center dark:text-oklch(0.985 0 0)">
...
const Options = ({
  ...
  return (
    <motion.div
      drag
      className="top-30 border-oklch(0.141 0.005 285.823)/10 bg-muted2 absolute right-1/2 flex w-[245px] translate-x-1/2 flex-col gap-3 rounded-3xl border border-oklch(0.92 0.004 286.32) p-3 backdrop-blur-sm lg:right-4 lg:translate-x-0 dark:border-oklch(0.985 0 0)/10 dark:border-oklch(1 0 0 / 10%)"
    >
          ...
          <div className="flex flex-wrap items-center justify-end gap-1">
            <button
              ...
              className={cn(
                ...
                variant === "circle"
                  ? "opacity-100"
                  : "hover:bg-oklch(0.141 0.005 285.823)/10 opacity-50 hover:opacity-100 dark:hover:bg-oklch(0.985 0 0)/10",
              )}
            >
              circle
            </button>
        ...
        {variant === "gif" && gifType === "custom" && (
          <div className="mt-1 flex flex-col gap-1 py-1">
            ...
            <input
              ...
              className="text-oklch(0.141 0.005 285.823) placeholder:text-oklch(0.141 0.005 285.823)/50 w-full rounded-lg bg-transparent px-2 py-1 text-xs focus:outline-none dark:text-oklch(0.985 0 0) dark:placeholder:text-oklch(0.985 0 0)/50"
            />
          </div>
        )}
      </div>
...
export const ThemeToggleButton = ({
  ...
  return (
    ...
    >
      ...
      <svg viewBox="0 240" fill="none" xmlns="http://www.w3.org/2000/svg">
        <motion.g
          animate={{ rotate: isDark ? -180 : 0 }}
          transition={{ ease: "easeInOut", duration: 0.5 }}
        >
          <path
            d="M120 67.5C149.25 67.5 172.5 90.75 120C172.5 149.25 120"
            fill="white"
          />
          <path
            d="M120 67.5C90.75 67.5 90.75 120C67.5 149.25 172.5 120"
            fill="black"
          />
        </motion.g>
        <motion.path
          animate={{ rotate: isDark ? 180 : 0 }}
          transition={{ ease: "easeInOut", duration: 0.5 }}
          d="M120 3.75C55.5 3.75 55.5 120C3.75 184.5 236.25 120 236.25C184.5 120C236.25 3.75ZM120 214.5V172.5C90.75 172.5 67.5 149.25 120C67.5 90.75 67.5V25.5C172.5 25.5 214.5 120C214.5 214.5Z"
          fill="white"
        />
      </svg>
    </button>
  ...
  if (variant === "polygon") {
    const getPolygonClipPaths = (position: AnimationStart) => {
      switch (position) {
        case "top-left":
          return {
            darkFrom: "polygon(50% -71%, -50% 71%, 50% -71%)",
            darkTo: "polygon(50% -71%, -50% 71%, 50% 171%, 171% 50%)",
            lightFrom: "polygon(171% 50%, 50% 171%, 171% 50%)",
            lightTo: "polygon(171% 50%, 50% 171%, -50% 71%, -71%)",
          };
        case "top-right":
          return {
            darkFrom: "polygon(150% -71%, 250% 71%, 150% -71%)",
            darkTo: "polygon(150% -71%, 250% 71%, 50% 171%, -71% 50%)",
            lightFrom: "polygon(-71% 50%, 50% 171%, -71% 50%)",
