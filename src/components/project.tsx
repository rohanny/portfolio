...
import preetiBhojanLogo from "../assets/images/Main.png";
import articleSummarizerLogo from "../assets/images/article.jpg";
import fineDineLogo from "../assets/images/fineDine.png";
import cinePhileLogo from "../assets/images/netflix.png";
